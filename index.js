...
const db = mysql.createConnection({
    host: 'db-container-1bbf416b-888f-4ecb-8092-cda64f322521', // Ensure this is correct
    user: 'root', // Replace with your MySQL username
    password: 'dnvl6lc08tr820wg4gir0o', // Replace with your MySQL password
    database: 'db_pnmj9y3x' // Ensure this matches your MySQL database
});
...
app.get('/', (req, res) => {
    const coolResponses = [
        "🚀 Welcome to the Node.js Express server, where coding dreams come true! latest",
        "✨ You've just landed in the realm of awesome Express servers after! latest",
        "🌟 Hello there, explorer! Ready to embark on a Node.js adventure? latest"
    ];
